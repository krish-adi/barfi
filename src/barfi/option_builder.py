def build_option(name: str, type: str, kwargs):
    ...
    if type == "checkbox":
        ...
        if "value" in kwargs:
            ...
            assert isinstance(
                value, int
            ), "Error: For checkbox option, 'value' must be of type integer."
        else:
            value = None
        option["value"] = value
        ...
        if "min" in kwargs:
            ...
            assert isinstance(
                min, int
            ), "Error: For checkbox option, 'min' must be of type integer."
        else:
            min = None
        option["min"] = min
        ...
        if "max" in kwargs:
            ...
            assert isinstance(
                max, int
            ), "Error: For checkbox option, 'max' must be of type integer."
        else:
            max = None
        option["max"] = max
        ...
        if "value" in kwargs:
            ...
            assert isinstance(
                value, str
            ), "Error: For select option, 'value' must be of string."
        else:
            value = None
        option["value"] = value
        ...
        assert min is not None, "Error: For slider option, 'min' must be specified."
        assert isinstance(min, int) or isinstance(
            min, float
        ...
        assert bool(max), "Error: For slider option, 'max' must be specified."
        assert isinstance(max, int) or isinstance(
            max, float
