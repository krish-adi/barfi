...
def subtraction_func(self):
    ...
    value = in_1 - in_2
    self.set_interface(name='Output 1', value=value)    
subtraction.add_calculate(subtraction_func)
...
def addition_func(self):
    ...
    value = in_1 + in_2
    self.set_interface(name='Output 1', value=value)    
addition.add_calculate(addition_func)
...
def multiplication_func(self):
    ...
    value = in_1 * in_2
    self.set_interface(name='Output 1', value=value)    
multiplication.add_calculate(multiplication_func)
...
def division_func(self):
    ...
    value = in_1 / in_2
    self.set_interface(name='Output 1', value=value)    
division.add_calculate(division_func)
