...
class TestBarfiBlock(unittest.TestCase):
    ...
    def test_block_inputs(self):
        block_1 = Block()
        block_1.add_input()
        self.assertEqual(block_1._inputs, {"Input 1": {"value": None, "id": None}})
        block_1.add_input(name="some input")
        self.assertEqual(
            block_1._inputs,
            {
                "Input 1": {"value": None, "id": None},
                "some input": {"value": None, "id": None},
            },
        )
    ...
    def test_block_outputs(self):
        block_1 = Block()
        block_1.add_output()
        self.assertEqual(block_1._outputs, {"Output 1": {"value": None, "id": None}})
        block_1.add_output(name="some output")
        self.assertEqual(
            block_1._outputs,
            {
                "Output 1": {"value": None, "id": None},
                "some output": {"value": None, "id": None},
            },
        )
        with self.assertRaises(ValueError):
    ...
    def test_set_interface(self):
        ...
        self.assertEqual(block_1._inputs, {"Input 1": {"value": 5, "id": None}})
        block_1._set_interface_id(name="Input 1", id=123456)
        self.assertEqual(block_1._inputs, {"Input 1": {"value": 5, "id": 123456}})
        block_1.add_output()
        block_1.set_interface(name="Output 1", value=5)
        self.assertEqual(block_1._outputs, {"Output 1": {"value": 5, "id": None}})
        block_1._set_interface_id(name="Output 1", id=123456)
        self.assertEqual(block_1._outputs, {"Output 1": {"value": 5, "id": 123456}})
